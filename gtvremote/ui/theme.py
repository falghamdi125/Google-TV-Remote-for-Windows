...
FIELD_BORDER = "#3a3f4b"  # sets a text box apart from the buttons beside it
POWER_BG = "#3a2126"
POWER_HOVER = "#54282f"
...
BUTTON_HEIGHT = 51        # every row: keys, app icons, entries and their buttons
SMALL_BUTTON_HEIGHT = 41  # dialog buttons
BAR_BUTTON_HEIGHT = 42    # connection bar: address box, Scan and Connect
DPAD_BUTTON_WIDTH = 72    # arrows and OK: a little larger than the other keys
DPAD_BUTTON_HEIGHT = 57
